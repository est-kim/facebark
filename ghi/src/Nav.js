    ...
    <MDBContainer fluid>
      ...
      <MDBCollapse navbar show={showNavRight}>
        <MDBNavbarNav right fullWidth={false} className="mb-2 mb-lg-0">
          <Link
            className={`${isLoggedIn ? "nav-link" : "d-none"} mobile-nav-link`}
          ...
          <li className={`nav-item dropdown mobile-nav-link`}>
            {isLoggedIn ? (
              <>
                <a
          ...
          <Link
            className={`${isLoggedIn ? "d-none" : "nav-link"} mobile-nav-link`}
            to="/signup"
